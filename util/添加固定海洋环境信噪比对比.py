...
noise_files = "../../../2016数据/noise.wav"
original_path = "../../../2016数据/0-1.wav"

# noise_files_path = "../Cut_smallShips/Natural ambient noise/85__E__1L.wa_1.wav"
# original_path = "../Cut_smallShips/Fishboat/76__23_07_13_1.wav"

soundData,fs = librosa.load(original_path,sr=None) # 降采样到16000
soundData = soundData[:fs]

noise_signal, noise_sr = librosa.load(noise_files, sr=None)
