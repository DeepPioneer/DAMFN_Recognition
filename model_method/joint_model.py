...
class Wavegram_Logmel(nn.Module):
    ...
    def forward(self, input):
        ...
        x = self.conv_block1(x, pool_size=(2, 1), pool_type='avg')
...
if __name__ == "__main__":
    ...
    model = Wavegram_Logmel(sample_rate=16000,window_size=1024,hop_size=320,mel_bins=64,fmin=50,fmax=8000,num_classes=5)
    output = model(x)
    print(output.shape)
