...
class Res2dNet18(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin,
                 fmax, num_classes):
        super(Res2dNet18, self).__init__()
...
if __name__ == "__main__":
    ...
    model = Res2dNet18(sample_rate=16000, window_size=1024, hop_size=320, mel_bins=64, fmin=50,
                     fmax=8000, num_classes=5)
    output = model(x)
