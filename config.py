...
def get_args_parser():
    ...
    parser.add_argument('--model_name', default='WaveMsNet',
                        choices=['fusion','hope',
                                'TSNA','WTS','SimPFs','wavevit','mpvit',
                                'Resnet1D','Resnet2D','joint','VIT','convnet',
                                'onlya','onlyv','private','shared','wofusion','woMoE','woTrans'],
    ...
    parser.add_argument('--data_type', type=str, default='Cut_ShipEar', choices=['Cut_ESC_10', 'Cut_ESC_50','Cut_deepShip',"Cut_ShipEar","Cut_whale"])
