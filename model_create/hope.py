...
class MISAWithGating(nn.Module):
    ...
    def alignment(self, input):
        ...
        h = torch.stack((self.utt_private_v, self.utt_private_a, self.utt_shared_a, self.utt_shared_v, fused_av), dim=0)
        # h = torch.stack((self.utt_private_v, self.utt_private_a, fused_av), dim=0)
